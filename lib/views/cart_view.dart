  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Consumer<CartDataService>(builder: (context, cProvider, child) {
        final subtotal = cProvider.calculateSubtotal();
                  ...
                  children: [
                    ...
                    Center(
                      child: Column(
                        children: [
                          Text(
                            asProvider.getString('Your cart is empty'),
                            style: TextStyle(
                              color: cc.greyHint,
                          ...
                          /*
                          Text(
                            asProvider.getString('Add item to cart!'),
                            style: TextStyle(
                              color: cc.greyHint,
                            ),
                          ),
              ...
              if (cProvider.cartList.isNotEmpty)
                Container(
                  ...
                  child: CustomCommonButton(
                    btText: asProvider.getString('Checkout'),
                    isLoading: false,
                    onPressed: () async {
                      if (cProvider.getSelectedItems().isEmpty) {
                        showToast(
                            asProvider
                                .getString('Please select at least one item'),
                            cc.red);
                        return;
                      }
      ...
      list.add(GestureDetector(
        ...
        child: CartTile(
          ...
          e['original_price'] is String
              ...
              : e['original_price'],
          e['rowId'],
          isSelected: e['isSelectedForPurchase'] ?? true,
