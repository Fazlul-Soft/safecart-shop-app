        ...
        child: Consumer<SearchProductService>(
          builder: (context, saProvider, child) {
            return FutureBuilder(
              future: !saProvider.loading && saProvider.searchedProduct == null
                  ? (() {
                      saProvider.setFilterOptions(subCatVal: subcatName);
                      return saProvider.fetchProducts(context);
                    })()
                  : null,
